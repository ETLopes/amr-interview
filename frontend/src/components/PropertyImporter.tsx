...
export function PropertyImporter() {
  ...
  const handleCreateSimulation = () => {
    ...
    const simulationData = {
      ...
      valorEntrada: importedProperty.price * 0.2,
      valorFinanciar: importedProperty.price * 0.8,
      totalGuardar: importedProperty.price * 0.15,
      valorMensalPoupanca: (importedProperty.price * 0.15) / (25 * 12),
    };
